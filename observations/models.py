...
class Observation(models.Model):
    ...
    implications = models.TextField(blank=True, help_text="Potentiella konsekvenser av denna observation.")
    type = models.CharField(
        max_length=20,
        choices=ObservationType.choices,
        default=ObservationType.SIGNAL
    )
    ...
    source_file = models.FileField(upload_to='observations/%Y/%m/%d/', blank=True, null=True)
